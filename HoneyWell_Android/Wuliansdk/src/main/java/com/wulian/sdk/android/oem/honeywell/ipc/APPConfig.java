/**
 * Project Name:  ICamToHoneyWellSDK
 * File Name:     APPConfig.java
 * Package Name:  main.java.ipc
 *
 * @Date: 2016年6月4日
...
public class APPConfig {
    ...
    public static final String DEFAULT_DOMAIN = "hw.sh.gg";// 默认的domain
    ...
    public static final String SP_REMEMVER_SERVER = "spRememberServer";
    public static final String SP_SERVER = "spServer";
    public static final String SP_IS_SET_SERVER = "spIsSetServer";
    public static final String SP_IS_REM_ACCOUNT = "isRemAccount";
    ...
    public static final String FIREWARE = "cmhw";
