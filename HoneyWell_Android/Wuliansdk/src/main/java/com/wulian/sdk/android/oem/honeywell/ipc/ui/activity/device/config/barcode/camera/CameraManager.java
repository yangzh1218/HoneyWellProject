...
package com.wulian.sdk.android.oem.honeywell.ipc.ui.activity.device.config.barcode.camera;
...
import com.wulian.sdk.android.oem.honeywell.ipc.ui.activity.device.config.barcode.camera.open.OpenCameraInterface;
...
public final class CameraManager {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			// 修改为正方形
			int squareWidth = width < height ? width : height;
			int leftOffset = (screenResolution.x - squareWidth) / 2;
			int topOffset = (screenResolution.y - squareWidth) / 2;
			// framingRect = new Rect(leftOffset, topOffset, leftOffset + width,
			// topOffset + height);
			framingRect = new Rect(leftOffset, topOffset, leftOffset
					+ squareWidth, topOffset + squareWidth);
