...
public class HistoryVideoSettingActivity extends BaseFragmentActivity implements
		OnClickListener {
	private TextView tv_save_time, tv_disk_memory, tv_save_time_day;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBaseView.bindView();
		mBaseView.setTitleView(R.string.setting_device_restore);
	...
	private void initViews() {
		...
		tv_disk_memory = (TextView) findViewById(R.id.tv_disk_memory);
	...
	private void initListeners() {
		...
		titlebar_right.setOnClickListener(getRightClick());
	}
	...
	protected OnClickListener getRightClick() {
		return new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// device.getDid() + APPConfig.HISTORY_SAVE_WEEKDAY,
				// ",").split(",");
				...
				SipController.getInstance().sendMessage(
						...
						SipHandler.ConfigPrerecordPlan("sip:"
								...
								recordPlanModel), SipFactory.getInstance().getSipProfile());
			}
		};
	}
	...
	public void updateWeekdayAndTime() {
		String tempWeekday = sp.getString(device.getDid()
				+ APPConfig.HISTORY_SAVE_WEEKDAY, "");
		String weekday = convertWeekday(tempWeekday);
		String tempTime = sp.getString(device.getDid()
	...
	protected void sipDataReturn(boolean isSuccess, SipMsgApiType apiType,
		...
		if (isSuccess) {
							...
							try {
								...
								tv_disk_memory
										.setText(Html.fromHtml(String.format(
												this.getString(R.string.replay_disk_memory),
												Utils.convertFileSize(freeSizeNum),
												Utils.convertFileSize(totalSizeNum))));
			...
			case QUERY_PRERECORD_PLAN:// 126 查询录像计划
				...
				String config_weekday = device.getDid()
						+ APPConfig.HISTORY_SAVE_WEEKDAY;
				String config_time = device.getDid()
						+ APPConfig.HISTORY_SAVE_TIME;
