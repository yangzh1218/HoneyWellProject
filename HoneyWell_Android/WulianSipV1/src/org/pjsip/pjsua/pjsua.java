...
public class pjsua implements pjsuaConstants {
  ...
  public synchronized static int call_dump_speed(int call_id, int with_media, String buffer, long maxlen, String indent) {
    return pjsuaJNI.call_dump_speed__SWIG_0(call_id, with_media, buffer, maxlen, indent);
  }

  public synchronized static int call_dump_nat(int call_id, int with_media, String buffer, long maxlen, String indent) {
    return pjsuaJNI.call_dump_nat__SWIG_0(call_id, with_media, buffer, maxlen, indent);
  }
  ...
  public static pj_str_t call_dump_speed(int call_id, int with_media, String indent) {
    return new pj_str_t(pjsuaJNI.call_dump_speed__SWIG_1(call_id, with_media, indent), true);
  }

  public static pj_str_t call_dump_nat(int call_id, int with_media, String indent) {
    return new pj_str_t(pjsuaJNI.call_dump_nat__SWIG_1(call_id, with_media, indent), true);
  }
  ...
  public static void css_on_call_media_event(int call_id, long med_idx, SWIGTYPE_p_pjmedia_event event) {
    pjsuaJNI.css_on_call_media_event(call_id, med_idx, SWIGTYPE_p_pjmedia_event.getCPtr(event));
  }
