...
public class ViESurfaceRenderer implements Callback {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format,
       ...
       WulianLog.d(TAG, "ViESurfaceRender::surfaceChanged");
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if(canvas != null) {
            ...
            if(dst != null) {
               ...
               WulianLog.d(TAG, "ViESurfaceRender::surfaceCreated" +
                        " dst.left:" + dst.left +
                        " dst.top:" + dst.top +
                        " dst.right:" + dst.right +
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
       WulianLog.d(TAG, "ViESurfaceRenderer::surfaceDestroyed");
        bitmap = null;
        byteBuffer = null;
    }

    public Bitmap CreateBitmap(int width, int height) {
       WulianLog.d(TAG, "CreateByteBitmap " + width + ":" + height);
        if (bitmap == null) {
            try {
    ...
    public ByteBuffer CreateByteBuffer(int width, int height) {
       WulianLog.d(TAG, "CreateByteBuffer " + width + ":" + height);
        if (bitmap == null) {
    ...
    public void SetCoordinates(float left, float top,
       ...
       WulianLog.d(TAG, "SetCoordinates " + left + "," + top + ":" +
                right + "," + bottom);
        dstLeftScale = left;
        dstTopScale = top;
        dstRightScale = right;
