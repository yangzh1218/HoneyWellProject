...
public class Threading {
	...
	public final static void stopHandlerThread(HandlerThread handlerThread,
		...
		try {
			...
			WulianLog
					.d(THIS_FILE,
							"Something is wrong with api level declared use fallback method");
		}
		...
		if (fails && handlerThread.isAlive() && wait) {
			try {
				...
				/*
				 * if (handlerThread.isAlive()) { handlerThread. }
				 */
			} catch (Exception e) {
				WulianLog.e(THIS_FILE, "Can t finish handler thread....", e);
			}
		}
	}
}
