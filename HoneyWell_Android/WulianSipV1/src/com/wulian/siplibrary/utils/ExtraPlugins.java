...
public class ExtraPlugins {
    ...
    public static Map<String, DynCodecInfos> getDynCodecPlugins(Context ctxt, String action){
        if(!CACHED_RESOLUTION.containsKey(action)) {
            ...
            try {
    			...
    			PackageInfo pi;
    			pi = packageManager.getPackageInfo(ctxt.getPackageName(), 0);
    			// 得到自己的包名
                ...
                for(ResolveInfo resInfo : availables) {
                    ...
                    if(actInfos.packageName.equalsIgnoreCase(pkgName)) {
                    	WulianLog.d(THIS_FILE, "pkgName is:"+pkgName);
                         ...
                         try {
                             ...
                             WulianLog.e(THIS_FILE, "Error while retrieving infos from dyn codec ", e);
                         }
                         break;
                    }
                }
    ...
    public static Map<String, DynActivityPlugin> getDynActivityPlugins1(Context ctxt, String action){
